                    ...
                    <div className="flex ">
                        {
                            placeholderList.map((item, index) => (
                                <div className='card card-applied flex row black-border' id={`adminOpeningGrid${index + 1}`}>
                                    ...
                                    <div>
                                        {item.isAvailable ? <p className="applied">Available</p> : <p p className="completed">Not Available</p>}
                                    </div>
                                    <img className='applied edit' 
                                    id='adminEditOpenings' width={20} height={20} src={editimgURL} alt="" />
                                    <img className='applied delete'  id='adminDelete' width={20} height={20} src={deleteimgURL} alt="" />
                                </div>
                            ))
                        }
                    </div>
